...
func (x *ListProductData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListProductData) ProtoMessage() {}

func (x *ListProductData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListProductData.ProtoReflect.Descriptor instead.
func (*ListProductData) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{1}
}

func (x *ListProductData) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ListProductData) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ListProductData) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *ListProductData) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type ListProductResponse struct {
	...
	Data       []*ListProductData `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
func (x *ListProductResponse) GetData() []*ListProductData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x52, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x50,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x22, 0x61, 0x0a, 0x0f, 0x4c,
	0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x92,
	...
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x4c, 0x69, 0x73,
	0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x70, 0x61, 0x67, 0x65,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x61,
	0x67, 0x65, 0x73, 0x22, 0x56, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f,
	...
	0x69, 0x64, 0x22, 0x6f, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x44, 0x61, 0x74,
	...
	0x69, 0x63, 0x65, 0x22, 0x20, 0x0a, 0x0e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xc0, 0x02, 0x0a, 0x0e, 0x50, 0x72,
	...
	0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3e,
	...
	0x64, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50,
	...
	0x12, 0x4a, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12,
	0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72,
...
var file_pkg_product_pb_product_proto_goTypes = []interface{}{
	(*ListProductRequest)(nil),    // 0: product.ListProductRequest
	(*ListProductData)(nil),       // 1: product.ListProductData
	...
	(*FindOneData)(nil),           // 5: product.FindOneData
	(*FindOneRequest)(nil),        // 6: product.FindOneRequest
	(*FindOneResponse)(nil),       // 7: product.FindOneResponse
...
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	1, // 0: product.ListProductResponse.data:type_name -> product.ListProductData
	5, // 1: product.FindOneResponse.data:type_name -> product.FindOneData
	3, // 2: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	6, // 3: product.ProductService.FindOne:input_type -> product.FindOneRequest
	8, // 4: product.ProductService.DecreaseStock:input_type -> product.DecreaseStockRequest
	0, // 5: product.ProductService.ListProduct:input_type -> product.ListProductRequest
	4, // 6: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
	7, // 7: product.ProductService.FindOne:output_type -> product.FindOneResponse
	9, // 8: product.ProductService.DecreaseStock:output_type -> product.DecreaseStockResponse
